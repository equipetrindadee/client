...
export const RevisaoT2 = ({ selectedUser }) => {
    ...
    return (
        <div className="main-t2">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="conteudo-left-t2">
                            <div className="campos-texts-t2">
                                ...
                                <div className="text3-t2 btn-bg-t2 text1NameColumnReceiveTemplete1-t2" id="text4BtnBg">
                                    <input
                                        className="upImg-t2 file-input-t2"
                                        type="file"
                        ...
                        <div className="text-footer-t2">
                            ...
                            <div className="text12-t2">
                                <button type="submit" className="send-btn-t2" href="/processopostagemProfessor">Salvar</button>
                                <button onClick={handleNavigateToPostagem} className="send-btn-t2">Enviar</button>
                            </div>
                        </div>
                    </form>
            ...
            {/* lado direito */}
            <div className="right-side-t2 lado2-t2" ref={rightSideRef}>
                <div className="main-right-t2">
                    ...
                    <div className="body-right-t2">
                            ...
                            <div className="info-mid-header-right-t2">
                                ...
                                {filteredPublication.length > 0 && (
                                    <div className="escrita-mid-header-right-t2">
                                        <h4 className='nameUserTemplete1WriterRightPart-t2'>
                                            {filteredPublication[0].author}  {/* Exibe o autor da publicação filtrada */}
                                        </h4>
                                        <p className='nameUserTemplete1WriterRightPartDate-t2'>
                        ...
                        <h1 className="titleNameColumnReceiveTemplete1-t2">{title}</h1>

                        <div className="conteudo-right-t2">
                            <div className="campos-t2">
                                <div className="campo1-t2">
                                    <p className="textValueReceiveTemplete1-t2">{texts[0]}</p>
                                </div>
                                ...
                                <div className="campo4-t2">
                                    <div className="campo4-card-t2">
                                       
                                        <p className="textValueReceiveTemplete1-t2">{texts[1]}</p>
                                    </div>
                                </div>

                                <div className="campo5-t2">
                                <div className="texto-t2">
                                            <p className="textValueReceiveTemplete1-t2 textWithBG-t2">{texts[2]}</p> {/* Texto do campo4 */}
                                        </div>
                                </div>

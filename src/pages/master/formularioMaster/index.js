...
import "../formularioMaster/formularioMaster.css";

export const FormularioMaster = () => {
  const [image, setImage] = useState(null);
  const [colunista, setColunista] = useState("naoColunista"); // Estado para as opções de Colunista
  const [tipoUsuario, setTipoUsuario] = useState("Tipo de Usuário"); // Estado para Tipo de Usuário
  const [coluna, setColuna] = useState("Selecione uma coluna"); // Estado para Colunas
  const [anoEscolar, setAnoEscolar] = useState("Ano escolar"); // Estado para Ano Escolar
  const [acessoProfessor, setAcessoProfessor] = useState("ilimitado"); // Estado para Acesso do Professor
=======
// import React, { useState } from "react";
// import "bootstrap/dist/css/bootstrap.min.css";
// import "bootstrap-icons/font/bootstrap-icons.css";
          ...
          <form className="formularioMaster-form">
            ...
            <div className="w-100 mb-3">
              <Dropdown onSelect={(eventKey) => setTipoUsuario(eventKey)}>
                <Dropdown.Toggle
                  variant="success"
                  className="FormularioMaster-dropdown-custom"
                  id="dropdown-basic"
                >
                  {tipoUsuario}
                </Dropdown.Toggle>
                <Dropdown.Menu className="formularioMaster-dropdown-Menu">
                  <Dropdown.Item
                    ...
                    className="FormularioMaster-dropdown-Item"
                  >
                    <p>Administrador</p>
                  </Dropdown.Item>
                  <Dropdown.Item
            ...
            {tipoUsuario === "Professor" && (
              <div className="d-flex justify-content-start align-items-center mb-3">
                <div className="form-check">
                  ...
                  />
                  <label className="form-check-label formularioMaster-Ilimitado">
                ...
                <div className="form-check ms-3">
                  <input
                    ...
                    onChange={handleProfessorAccessChange}
                  />
                  <label className="form-check-label  formularioMaster-Limitado">
                    <p>Acesso Limitado</p>
                  </label>
                </div>
              </div>
            ...
            {tipoUsuario === "Aluno" && (
              <div className="d-flex justify-content-start align-items-center mb-3">
                <div className="form-check">
                  ...
                  />
                  <label className="form-check-label formularioMaster-Colunista">
                    <p>Colunista</p>
                  </label>
                </div>
                <div className="form-check ms-3">
                  <input
                    ...
                    onChange={handleColunistaChange}
                  />
                  <label className="form-check-label fomularioMaster-Nopcolunista">
                    <p>Não colunista</p>
                  </label>
                </div>
              </div>
            ...
            <div className="text-center">
              <button
                type="submit"
                className="btn btn-primary formularioMaster-submit-button"
              >
                CADASTRAR
              </button>
            </div>
...
//     setColunista(event.target.value); // Atualiza o valor de colunista
// >>>>>>> 07b75f853abfe50a096439256c2d1b28872fa06b
//   };
...
//         {/* Opções de Colunista (apenas para Aluno) */}
//         {tipoUsuario === "Aluno" && (
//           <div className="d-flex justify-content-start align-items-center mb-3">
//             <div className="form-check">
//               <input
...
//               />
//               <label className="form-check-label">Colunista</label>
//             </div>
//             <div className="form-check ms-3">
//               <input
//                 className="form-check-input"
...
//                 onChange={handleRadioChange}
//               />
//               <label className="form-check-label">Não colunista</label>
//             </div>
//           </div>
//         )}
